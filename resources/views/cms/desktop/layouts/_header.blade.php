...
<div class="fly-header layui-bg-black">
    <div class="layui-container">
        <a class="fly-logo" href="/">
            @if(config("system.common.basic.logo") != '')
                <img src="{{storage_image_url(config("system.common.basic.logo"))}}" alt="{{config("system.common.basic.name")}}">
            @else
                <span style="font-size: 28px;color: white;">
                {{config("system.common.basic.name")}}
                </span>
            @endif
        </a>
...
<div class="fly-panel fly-column">
    <div class="layui-container">
        @include('cms.desktop.layouts._breadcrumb')
