...
<html lang="{{ app()->getLocale() }}">
    ...
    <body  class="{{ route_class() }}-body">
        ...
        <div id="app" class="{{ route_class() }}-page">
            ...
            @include('cms.desktop.layouts._header')
            ...
            @include('cms.desktop.layouts._footer')
        </div>
        ...
        @include('cms.desktop.layouts._message')

        @include('cms.desktop.layouts._error')

        @include('cms.desktop.layouts._script')

        @yield('scripts')

        @include('cms.desktop.layouts._statistics')
    </body>
</html>
