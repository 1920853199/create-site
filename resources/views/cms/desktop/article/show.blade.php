@extends('cms.desktop.layouts.app')
          ...
          <div class="layui-row layui-col-space15">
            <div class="layui-col-md8 content detail">
                ...
                <div class="fly-panel detail-box" id="flyReply">
                    ...
                    @include('cms.desktop.article._reply_list', ['replies' => $article->replies()->with('user')->get()])
                    @includeWhen(Auth::check(),'cms.desktop.article._reply_box', ['article' => $article])
            ...
            <div class="layui-col-md4">
                @include('cms.desktop.layouts._side')
            </div>
