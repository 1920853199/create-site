...
return [
    ...
    'menu' => [
        ...
        "goods" => [
            "id" => "goods",
            "text" => "商品管理",
            "permission" => function(){ return Auth::user()->can('manage_goods'); },
            "icon" => "icon-th-list",
            "link" => "",
            "route" => "",
            "params" => [],
            "children" => [
                ...
                "goods.cate" => [
                    "id" => "content.category.goods",
                    "text" => "分类管理",
                    "permission" => function(){ return Auth::user()->can('manage_goods_cate'); },
                    "icon" => "icon-branch",
                    "link" => "",
                ...
                "goods.attr" => [
                    "id" => "goods.attr",
                    "text" => "属性管理",
                    "permission" => function(){ return Auth::user()->can('manage_goods_attr'); },
                    "icon" => "icon-tag",
                    "link" => "",
                    "route" => "attr.index",
                    "params" => [],
        ...
        "group" => [
            "id" => "group",
            "text" => "站点管理",
            "permission" => function(){ return Auth::user()->can('manage_website_group'); },
            "icon" => "icon-desktop",
            "link" => "",
            "route" => "",
            "params" => [],
            "children" => [
                "group.site" => [
                    ...
                    "icon" => "icon-desktop",
                    "link" => "",
                    "route" => "administrator.group.index",
                    "params" => [],
                    "query" => [],
                ],
                "group.template" => [
                    "id" => "group.template",
                    "text" => "模板管理",
                    "permission" => function(){ return Auth::user()->can('manage_website_template'); },
                    "icon" => "icon-html5",
                    "link" => "",
